  ...
  return (
    ...
    >
      <div className="relative aspect-square md:aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl shadow-[var(--shadow-color)] group bg-[var(--surface)]">
        ...
        />
        <div className="absolute bottom-8 left-8 right-8 z-20 bg-[var(--surface)]/95 backdrop-blur-md p-6 rounded-2xl shadow-xl border border-[var(--border-subtle)]">
      ...
      <div className="space-y-8">
        ...
        <ul className="space-y-4 pt-2">
          {[
            ...
            >
              <div className="mt-1 bg-sky-100 p-1.5 rounded-full flex-shrink-0 shadow-sm border border-sky-200">
